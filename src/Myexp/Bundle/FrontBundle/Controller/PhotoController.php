...
use Myexp\Bundle\AdminBundle\Entity\Photo;
use Myexp\Bundle\AdminBundle\Entity\PhotoTranslation;
use Myexp\Bundle\AdminBundle\Form\PhotoType;
use Myexp\Bundle\AdminBundle\Helper\Paginator;
...
class PhotoController extends Controller {
    ...
    public function indexAction() {
        ...
        $photoRepo = $this->getDoctrine()->getManager()->getRepository('MyexpAdminBundle:Photo');
    ...
    public function statusAction() {
        ...
        $ep = $this->getDoctrine()->getRepository('MyexpAdminBundle:Photo');
     ...
     * @Method("POST")
     * @Template("MyexpAdminBundle:Photo:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('MyexpAdminBundle:Photo')->find($id);
    ...
    public function listAction($name) {
        ...
        $entity = $em->getRepository('MyexpAdminBundle:Album')->findOneBy(array(
            'name' => $name
        ));
     ...
     * @Method("PUT")
     * @Template("MyexpAdminBundle:Photo:edit.html.twig")
     */
    ...
    public function sliderAction($id) {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('MyexpAdminBundle:Photo')->getSlider($id);
