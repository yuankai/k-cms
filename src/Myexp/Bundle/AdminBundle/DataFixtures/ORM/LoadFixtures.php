...
namespace Myexp\Bundle\AdminBundle\DataFixtures\ORM;
...
class LoadFixtures implements FixtureInterface, ContainerAwareInterface {
    ...
    private function loadUsers(ObjectManager $manager) {
        ...
        $userRole = $manager->getRepository('MyexpAdminBundle:Role')
                ->findOneBy(array('role' => 'ROLE_USER'));
        $adminRole = $manager->getRepository('MyexpAdminBundle:Role')
