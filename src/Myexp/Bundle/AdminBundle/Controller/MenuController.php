...
use Myexp\Bundle\AdminBundle\Entity\Menu;
use Myexp\Bundle\AdminBundle\Form\MenuType;
...
class MenuController extends AdminController {
     ...
     * @Security("has_role('ROLE_ADMIN')")
     * @Method("POST")
     * @Template("MyexpAdminBundle:Admin/Menu:new.html.twig")
     */
    ...
    public function editAction($id) {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('MyexpAdminBundle:Menu')->find($id);
     ...
     * @Security("has_role('ROLE_ADMIN')")
     * @Method("PUT")
     * @Template("MyexpAdminBundle:Admin/Menu:edit.html.twig")
     */
