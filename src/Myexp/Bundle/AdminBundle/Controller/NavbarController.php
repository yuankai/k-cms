...
class NavbarController extends Controller {
    ...
    public function notificationsAction($max = 5) {
        ...
        return $this->render(
                        'AvanzuAdminThemeBundle:Navbar:notifications.html.twig', array(
    ...
    public function messagesAction($max = 5) {
        ...
        return $this->render(
                        'AvanzuAdminThemeBundle:Navbar:messages.html.twig', array(
    ...
    public function tasksAction($max = 5) {
        ...
        return $this->render(
                        'AvanzuAdminThemeBundle:Navbar:tasks.html.twig', array(
    ...
    public function userAction() {
        ...
        return $this->render(
                        'MyexpAdminBundle:Chips:user_dropdown.html.twig', array(
