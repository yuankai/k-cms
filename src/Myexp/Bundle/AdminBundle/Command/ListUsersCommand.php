...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        $users = $this->entityManager->getRepository('MyexpAdminBundle:User')->findBy(array(), array('id' => 'DESC'), $maxResults);
        ...
        $usersAsPlainArrays = array_map(function (User $user) {
            ...
            return array($user->getId(), $user->getUsername(), $user->getEmail(), implode(', ', $roles));
        }, $users);
    ...
    private function sendReport($contents, $recipient) {
        ...
        $message = $mailer->createMessage()
                ->setSubject(sprintf('k-cms:list-users report (%s)', date('Y-m-d H:i:s')))
