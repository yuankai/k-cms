...
class AddUserCommand extends ContainerAwareCommand {
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        $existingUser = $this->entityManager->getRepository('MyexpAdminBundle:User')->findOneBy(array('username' => $username));
        ...
        $userRole = $this->entityManager->getRepository('MyexpAdminBundle:Role')->findOneBy(array('role' => 'ROLE_USER'));
        $user->addRole($userRole);

        if ($isAdmin) {
            $adminRole = $this->entityManager->getRepository('MyexpAdminBundle:Role')->findOneBy(array('role' => 'ROLE_ADMIN'));
