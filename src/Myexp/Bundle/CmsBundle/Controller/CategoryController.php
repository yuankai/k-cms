...
class CategoryController extends Controller {
    ...
    private function getCategoryByRecursive(&$result, $parent = null, $depth = 0) {
        ...
        $entities = $em->getRepository('SmtCmsBundle:Category')->getChildren($parent);
     ...
     * @Secure(roles="ROLE_ADMIN_USER")
     * @Method("POST")
     * @Template("SmtCmsBundle:Category:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('SmtCmsBundle:Category')->find($id);
     ...
     * @Secure(roles="ROLE_ADMIN_USER")
     * @Method("PUT")
     * @Template("SmtCmsBundle:Category:edit.html.twig")
     */
