...
use Myexp\Bundle\CmsBundle\Entity\MenuItem;
use Myexp\Bundle\CmsBundle\Form\MenuItemType;
...
class MenuItemController extends AdminController {
    ...
    public function newAction(Request $request) {
        ...
        $menu = $this
                ->getDoctrine()
                ->getRepository('MyexpCmsBundle:Menu')
                ->find($menuId)
        ;
    ...
    public function updateAction(Request $request, $id) {
        ...
        $entity = $em->getRepository('MyexpCmsBundle:MenuItem')->find($id);
